...
const messageHandler = {
    ...
    insertSnippet(global, message){
        var text = message.snippet;
        var editor = vscode.window.activeTextEditor;
        var newline = new editor.document.lineAt(editor.document.lineCount+1);
        editor.insertSnippet(new vscode.SnippetString(text), new vscode.Position(newline, 0));
    },
    // 显示错误提示
...
module.exports = function(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('extension.methodRecommendView', function(uri) {
        console.log("method recommend")
